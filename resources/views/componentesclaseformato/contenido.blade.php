    ...
    <div class="relative z-10">
        ...
        <div class="mb-12">
            <h2 class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-white mb-6 flex items-center group">
                ...
                <div class="flex flex-col">
                    <span class="block leading-tight text-3xl font-bold tracking-wide">Contenido Principal</span>
                    <span class="text-lg text-red-300 font-semibold bg-red-900/20 px-4 py-2 rounded-xl mt-3 inline-flex items-center w-fit">
                        ...
                        Descripción Adicional - Detalles (X horas - X min)
                    </span>
                </div>
            </h2>
            ...
            <div class="flex items-center space-x-3 mb-8">
                ...
                <span class="text-base text-gray-300 font-medium">X secciones interactivas</span>
            </div>
        </div>
        ...
        <div class="prose prose-xl font-sans leading-relaxed max-w-none text-gray-200 relative">
            ...
            <div class="space-y-8 relative z-10">
                @include('componentesclaseformato.subcontent.seccion1')
                @include('componentesclaseformato.subcontent.seccion2')
                @include('componentesclaseformato.subcontent.seccion3')
            ...
            <div class="mt-12 pt-8 border-t border-gray-700/50">
                <div class="flex items-center justify-between text-base text-gray-400">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-red-300 font-semibold text-lg">Audiencia objetivo</p>
                    </div>
                </div>
            </div>
        </div>
