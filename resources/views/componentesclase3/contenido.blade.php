<!-- Componente de contenido principal para la clase de Jerarquía de operaciones -->
<div class="bg-gradient-to-br from-gray-800 via-gray-900 to-black backdrop-blur-lg bg-opacity-90 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] p-12 font-serif overflow-hidden relative transition-all duration-500 hover:shadow-[0_15px_40px_rgba(0,0,0,0.7)]">
    ...
    <div class="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full -mt-16 -mr-16 blur-3xl animate-pulse"></div>
    <div class="absolute bottom-0 left-0 w-56 h-56 bg-gradient-to-tr from-purple-500/10 to-blue-500/10 rounded-full -mb-12 -ml-12 blur-2xl animate-pulse delay-1000"></div>
    ...
    <div class="relative z-10">
        ...
        <div class="mb-12">
            <h2 class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-white mb-6 flex items-center group">
                <span class="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-600 w-16 h-16 rounded-2xl flex items-center justify-center mr-6 shadow-xl group-hover:shadow-blue-500/25 transition-all duration-300 group-hover:scale-110 relative overflow-hidden">
                ...
                <div class="flex flex-col">
                    <span class="block leading-tight text-3xl font-bold tracking-wide">Jerarquía de Operaciones Matemáticas</span>                    <span class="text-lg text-blue-300 font-semibold bg-blue-900/20 px-4 py-2 rounded-xl mt-3 inline-flex items-center w-fit">
            ...
            <div class="w-full h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent mb-6"></div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-700/50">
                <div class="flex items-center justify-between text-base text-gray-400">
                    <div class="flex items-center space-x-6">
                        ...
                        <p class="text-blue-300 font-semibold text-lg">Aspirantes Universitarios</p>
                    </div>
                </div>
            </div>
        </div>
