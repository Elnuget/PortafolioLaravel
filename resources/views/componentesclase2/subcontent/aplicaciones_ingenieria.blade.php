...
<div class="bg-gray-800 p-6 rounded-lg shadow-md mb-8">
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-yellow-900 p-6 rounded-lg">
            <h5 class="text-yellow-200 font-medium mb-4 flex items-center">
                <span class="bg-yellow-600 w-10 h-10 rounded-full flex items-center justify-center mr-3">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-3">
                <div class="bg-yellow-800 p-3 rounded">
                    <p class="text-yellow-200 font-medium">Balance de Masa</p>
                    <p class="text-yellow-100 text-sm">Entrada = Salida + Acumulación</p>
                    <p class="text-yellow-100 text-xs">Conservación de materia en procesos</p>
                </div>
                <div class="bg-yellow-800 p-3 rounded">
                    <p class="text-yellow-200 font-medium">Concentraciones</p>
                    <p class="text-yellow-100 text-sm">C₁V₁ + C₂V₂ = C₃V₃</p>
                    <p class="text-yellow-100 text-xs">Mezclas y diluciones</p>
                </div>
                <div class="bg-yellow-800 p-3 rounded">
                    <p class="text-yellow-200 font-medium">Reacciones Químicas</p>
                    <p class="text-yellow-100 text-sm">aA + bB → cC + dD</p>
                    <p class="text-yellow-100 text-xs">Estequiometría y balances molares</p>
                </div>
            </div>
        </div>
    </div>

    <div class="bg-teal-900 p-6 rounded-lg mb-6">
        <h5 class="text-teal-200 font-medium mb-4">🎯 Caso de Estudio: Diseño de un Puente</h5>
        <div class="text-teal-100 text-sm space-y-3">
            <p><strong>Problema:</strong> Un puente debe soportar un peso total de 5000 N distribuido en tres puntos. El punto A soporta el doble que el punto B, y el punto C soporta 500 N más que el punto B. ¿Cuánto peso soporta cada punto?</p>
            
            <div class="bg-teal-800 p-4 rounded">
                <p><strong>Variables:</strong></p>
                <ul class="ml-4 space-y-1">
                    <li>• B = peso en el punto B</li>
                    <li>• A = 2B (el doble que B)</li>
                    <li>• C = B + 500 (500 N más que B)</li>
                </ul>
            </div>
            
            <div class="bg-teal-800 p-4 rounded">
                <p><strong>Ecuación:</strong> A + B + C = 5000</p>
                <p><strong>Sustituyendo:</strong> 2B + B + (B + 500) = 5000</p>
                <p><strong>Simplificando:</strong> 4B + 500 = 5000</p>
                <p><strong>Resolviendo:</strong> B = 1125 N</p>
            </div>
            
            <div class="bg-teal-800 p-4 rounded">
                <p><strong>Respuesta:</strong></p>
                <ul class="ml-4 space-y-1">
                    <li>• Punto A: 2250 N</li>
                    <li>• Punto B: 1125 N</li>
                    <li>• Punto C: 1625 N</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="bg-red-900 p-4 rounded-lg">
        <h5 class="text-red-200 font-medium mb-3">🚀 Importancia para tu Futuro en la EPN</h5>
        <ul class="text-red-100 text-sm space-y-1">
            <li>• <strong>Primer semestre:</strong> Cálculo I y Álgebra Lineal requieren estas bases</li>
            <li>• <strong>Cursos de ingeniería:</strong> Todas las materias usan sistemas de ecuaciones</li>
            <li>• <strong>Proyectos de titulación:</strong> Modelamiento matemático de problemas reales</li>
            <li>• <strong>Vida profesional:</strong> Diseño, optimización y análisis de sistemas</li>
        </ul>
    </div>
</div>
