...
<div class="space-y-6 font-['Poppins',sans-serif] relative w-full">
    <!-- Efecto de fondo para el sidebar -->
    <div class="absolute inset-0 bg-gradient-to-b from-transparent via-slate-900/10 to-transparent pointer-events-none rounded-xl"></div>
