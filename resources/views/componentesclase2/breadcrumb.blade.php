    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 w-full">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-red-400 md:ml-2 font-['Poppins',sans-serif]">Planteo de Ecuaciones</span>
            </div>
        </li>
        <li class="ml-auto">
            <span class="bg-red-800 text-white px-3 py-1 rounded-full text-xs font-bold font-['Poppins',sans-serif] tracking-wide">EPN</span>
        </li>
    </ol>
</nav>
